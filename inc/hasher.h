...
/**
 * @brief Структура отпечатка файла, содержащая MinHash-подписи
 * 
...
/**
 * @brief Изучив документацию по функционалу blake3 
 *        на их официальном github
 *        можем написать функцию для хэширования данных файла 
 * 
...
/**
 * @brief Функция сравнения для значений хешей
 * 
 ...
 * 
 * Разбивает файл на блоки по 1 МБ и вычисляет BLAKE3 хеш для каждого
 * 
...
/**
 * @brief Строит полный отпечаток файла с использованием MinHash
 * 
 * Объединяет операции calculate_file_hashes() и min_hashes()
 * 
 * @param filepath Путь к исходному файлу
 * @param k Количество минимальных хешей для отпечатка
 ...
 * @param min_size Минимальный размер в байтах (например, 1 МБ = 1048576 байт)
